...
export default function CardWorkAndStatus({ name, day, value, status }) {
  const item = {
  ...
  return (
    <motion.div
      variants={item}
      className={`flex flex-none flex-col rounded-lg w-2/3 lg:w-full p-4 bg-white transform group hover:scale-105 hover:shadow-lg motion-reduce:transform-none transition-all duration-300 ease-in-out`}>
