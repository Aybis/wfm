...
export default function CardUnit({ name, value }) {
  return (
    <div className="p-3 transform group hover:scale-105 motion-reduce:transform-none transition-all duration-300 ease-in-out">
      <div className="flex gap-4 bg-gradient-to-br from-transparent via-gray-50 to-white rounded-md p-3 lg:h-28 w-72 h-24 group-hover:shadow-lg transition-all duration-300 ease-in-out">
        <ServerIcon className="h-8 w-8 rounded text-apps-primary" />
