  ...
  return (
    <div className="flex flex-col mb-2">
      {labelName && (
        <label
          htmlFor=""
          className="show text-sm mb-2 text-gray-600 font-semibold">
          {labelName}
        </label>
      )}
      <div className="relative" ref={selectWrapper} onClick={toggleSelect}>
        <div
          className={[
            "flex justify-between cursor-pointer bg-white focus:outline-none transition-all duration-200 border p-2 w-full rounded",
            toggle ? "border-blue-500" : "border-gray-300",
            className,
          ].join(" ")}>
