...
export default function Karyawan() {
  ...
  return totalUsers > 0 ? (
    <div className="relative mt-8">
      ...
      <div className="flex justify-between items-center mt-4 pb-2 border-b border-gray-200">
        {state.currentPage && (
          ...
          <div key={Math.random()} className="flex flex-col gap-4 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div className="grid grid-cols-4 gap-2 p-2 bg-warmGray-100 rounded-md">
              <div className="flex flex-col justify-start gap-1">
                ...
                <h1 className="text-sm text-gray-800 font-semibold">{user.wfh + user.wfo + user.satelit}</h1>
              </div>
              <div className="flex flex-col justify-start gap-1">
                <h1 className="text-xs text-gray-400 tracking-wide">Telat</h1>
                <h1 className="text-sm text-gray-800 font-semibold">{user.telat}</h1>
              </div>
              <div className="flex flex-col justify-start gap-1">
                <h1 className="text-xs text-gray-400 tracking-wide">Absen</h1>
                <h1 className="text-sm text-gray-800 font-semibold">{user.tidak_hadir}</h1>
              </div>
              <div className="flex flex-col justify-start gap-1">
                <h1 className="text-xs text-gray-400 tracking-wide">Keterangan</h1>
                <h1 className="text-sm text-gray-800 font-semibold">{user.cuti + user.sppd}</h1>
              </div>
            </div>
          </div>
        ))}
