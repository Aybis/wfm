...
export default function Menu() {
  const isTabletOrMobile = useMediaQuery({ query: '(min-width: 1225px' });
  ...
  return (
    isTabletOrMobile && (
      <nav className="transition-all duration-300 ease-in-out fixed  flex rounded-2xl z-30 inset-x-0 mx-8 bottom-0 h-auto inset-y-0 w-32 flex-col justify-between bg-white my-4 ml-4 ">
